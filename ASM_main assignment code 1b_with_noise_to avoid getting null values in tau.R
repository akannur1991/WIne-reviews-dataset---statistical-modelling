...
#Add noise to points col incase any regions have same ratings repeated. It will give variance as zero and tau as null.
df1$points<-df1$points + rnorm(nrow(df1), 1, 1)/10000
...
compare_m_gibbs <- function(y, ind, mu0 = 50, tau0 = 1/400,
                            a0 = 1, b0 = 50, alpha0 =1, beta0 = 50, maxiter = 10)
{
...
gt_x<-  sorted > averagePoints       # TRUE or FALSE
View(names(sorted[gt_x]))
View(sorted[gt_x])
